...
class MenuOption (pygame.font.Font):
    def __init__(self, text, function, position=(0, 0), font=None,
                 font_size=36, font_color=colors.WHITE):
    ...
    def highlight(self, color=colors.GREEN):
...
class Menu():
    def __init__(self, screen, functions, bg_color=colors.BLACK):
        self.is_active = True
        self.screen = screen
